namespace BibliothèqueUniversitaire.Migrations
{
    ...
    public partial class InitCreationDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.maison_edition", t => t.MaisonEdition_Id)
        ...
        {
            DropForeignKey("dbo.maison_edition", "id_provenance", "dbo.provenance");
            ...
            DropForeignKey("dbo.livre", "MaisonEdition_Id", "dbo.maison_edition");
            DropForeignKey("dbo.emprunt", "Adherent_Id", "dbo.adherent");
            DropIndex("dbo.maison_edition", new[] { "id_provenance" });
