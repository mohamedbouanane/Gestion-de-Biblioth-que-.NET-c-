...
namespace BibliothèqueUniversitaire.Models
{
    ...
    public partial class LivreEntity
    {
        ...
        public LivreEntity(string titre, uint nbrPages, double prix, ICollection<AuteurEntity> auteurs, MaisonEditionEntity maisonEdition, ProvenanceEntity provenance)
        {
            Titre = titre;
            NbrPages = nbrPages;
            Prix = prix;
